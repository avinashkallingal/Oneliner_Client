...
//   //     console.log(
//   //       offer.offer.offer,
//   //       "hii recieved ofjsajsjsjfer from sender%%%%%%%%%%%%"
//   //     );
...
//   // useEffect(()=>{
//   //   socketService.getAcceptConform(async(ans:any)=>{
//   //     await peer.setRemoteDescription(ans.ans.ans)
//   //     console.log(ans.ans.ans,"call accepted*******************")
//   //   })
//   // })
//   // useEffect(() => {
//   //   socketService.getAcceptConform(async (ans: any) => {
//   //     try {
//   //       // Await to ensure the remote description is set before proceeding
//   //       // await peer.setRemoteDescription(ans.ans.ans);
//   //       console.log(ans.ans.ans, "call accepted*******************");
//   //     } catch (error) {
